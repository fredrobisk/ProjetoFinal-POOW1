...
<main class="conteudo">
    ...
    <section class="cards">
        <article class="card">
            ...
            <a class="botao-link" href="${pageContext.request.contextPath}/alunos">Gerenciar alunos</a>
        </article>

        <article class="card">
            <h2>Planos ativos</h2>
            <p class="numero-dashboard">${resumo.totalPlanosAtivos}</p>
            <a class="botao-link" href="${pageContext.request.contextPath}/planos">Gerenciar planos</a>
        </article>

        <article class="card">
            <h2>Treinos ativos</h2>
            <p class="numero-dashboard">${resumo.totalTreinosAtivos}</p>
            <a class="botao-link" href="${pageContext.request.contextPath}/treinos">Gerenciar treinos</a>
        </article>
    </section>
